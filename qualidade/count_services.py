...
class CompletudeServico():
    def getservicos(self):
        ...
        Count = 0
        CountUnits = 0
        print 'ID', '\t', 'Status', '\t', 'SIGLA', '\t', 'NOME', '\t', 'Servicos ', '\t', 'Grupo', '\t' 'Unidades '
        for i in organ:
            ...
            if organDentro['id'] in ['56d6ddc18c36c706ac000004', '56df02e98c36c74559000000', '588bae3e8c36c708b4355182',
                ...
                grupo = 2
                                       ...
                                       '596e4d008c36c70a18c2cc92'] and organDentro['active'] == 'true':
                grupo = 3
                                       ...
                                       '5975ef298c36c75066f557fe', '5975fae08c36c76601b0494f', '58e233698c36c738a1844d9a']:
            ...
            print organDentro['id'], '\t', organDentro['active'], '\t', organDentro['acronym'], '\t', organDentro['name'], '\t', Count, '\t', grupo, '\t', CountUnits
